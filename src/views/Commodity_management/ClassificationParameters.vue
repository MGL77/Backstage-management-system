...
<script>
import { getGoodsCate, getGoodsParams } from "../../http/api";
export default {
  data() {
    return {
      // 商品分类列表
  ...
  methods: {
    ...
    async getParamsData() {
      ...
      const res = await getGoodsParams(this.getCateId, this.activeTabsName);
    ...
    addParams() {
      this.$refs.addFromRef.validate(async valid => {
        ...
        const { data: res } = await this.http({
          url: `https://www.liulongbin.top:8888/api/private/v1/categories/${this.getCateId}/attributes`,
          method: "post",
          data: {
    ...
    async showEditDialog(attrId) {
      const { data: res } = await this.http({
        url: `https://www.liulongbin.top:8888/api/private/v1/categories/${this.getCateId}/attributes/${attrId}`,
        method: "get",
        params: {
          attr_sel: this.activeTabsName
        }
    ...
    editParams() {
      this.$refs.editFromRef.validate(async valid => {
        if (!valid) return;
        const { data: res } = await this.http({
          url: `https://www.liulongbin.top:8888/api/private/v1/categories/${this.getCateId}/attributes/${this.editFrom.attr_id}`,
          method: "put",
          data: {
